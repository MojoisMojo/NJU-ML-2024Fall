    ...
    def train(self):
        ...
        for idx_epoch in range(self.max_epoch):
            ...
            for idx_batch in range(max_batch):
                batch_images = self.train_data[
                    idx_batch * self.batch_size : (idx_batch + 1) * self.batch_size, :-1
                ]
                batch_labels = self.train_data[
                    idx_batch * self.batch_size : (idx_batch + 1) * self.batch_size, -1
                ]
                ...
                if idx_batch % self.print_iter == 0:
                    print(
                        "Epoch %d, iter %d, loss: %.6f" % (idx_epoch, idx_batch, loss)
                    )
